	...
	var Core = {
		...
		slickCarousel: function() {
			...
			if ( slick_top_bar_carousel.exists() ) {
				slick_top_bar_carousel.slick({
					...
					slidesToShow: 4,
					variableWidth: true,
					prevArrow:"<button class='slick-prev'><svg role='img' class='df-icon df-icon--left-arrow'><use xlink:href='https://Jayantara.test/assets/img/Jayantara.svg#left-arrow'/></svg></button>",
					nextArrow:"<button class='slick-next'><svg role='img' class='df-icon df-icon--right-arrow'><use xlink:href='https://Jayantara.test/assets/img/Jayantara.svg#right-arrow'/></svg></button>",
					responsive: [
						{
							breakpoint: 768,
							settings: "unslick"
			...
			if ( slick_team_carousel.exists() ) {
				...
				slick_team_carousel.slick({
					...
					customPaging: function(slick,index) {
						...
						return '<svg role="img" class="df-icon df-icon--' + icon + '"><use xlink:href="https://Jayantara.test/assets/img/Jayantara.svg#' + icon + '"/></svg>';
					},
		...
		miscScripts: function() {
			...
			$( '#dl-menu' ).dlmenu({
				...
				backLabel: '<svg role="img" class="df-icon df-icon--left-arrow"><use xlink:href="https://Jayantara.test/assets/img/Jayantara.svg#left-arrow"></use></svg>' + ' ' + 'Back',
			});
